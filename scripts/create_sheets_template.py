...
SHEET_STRUCTURES = {
    "Каналы для мониторинга": {
        ...
        "validations": {
            "F": {"type": "BOOLEAN"},  # Активен
        },
        "examples": {
            1: ["1", "@avito_auto", "Авито Авто", "+79991234567", "auto_dealer", "TRUE", "2025-10-23", "0", ""],
            2: ["2", "@auto_ru", "Авто.ру", "+79997654321", "sales_avto", "TRUE", "2025-10-23", "0", ""],
        },
        "comments": {
            "B1": "Формат: @username или t.me/channelname",
            "D1": "Номер телефона продавца (заполняется вручную)",
            "E1": "Telegram username продавца (заполняется вручную)",
            "F1": "TRUE для включения мониторинга, FALSE для отключения",
        },
    },
    "Настройки фильтров": {
        "headers": [
